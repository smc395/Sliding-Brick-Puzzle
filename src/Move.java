...
public class Move {
    ...
    public Map<Piece, Map<Direction, ArrayList<Position>>> listAllMoves(Board boardState) {
    ...
    public void setSelectedMove(ArrayList<Position> move){
        selectedMove = move;
    }
    
    public ArrayList<Position> getSelectedMove(){
        return selectedMove;
    }
}
